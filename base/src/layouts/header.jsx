    ...
    <header>
      <nav className='bg-[#232833] h-12 flex items-center xl:h-14 2xl:h-16'>
        <ul className="w-1/2 flex justify-between px-5 text-gray-400 font font-rubik text-base xl:text-2xl 2xl:text-3xl  ">
          <li><a className="hover:text-gray-200 underline-offset-[3px] hover:underline-offset-4" href="/">Inicio</a></li>
          <li><a className="hover:text-gray-200" href="/acerca">Acerca de</a></li>
          <li><a className="hover:text-gray-200" href="/servicios">Servicios</a></li> {/* Enlace corregido */}
